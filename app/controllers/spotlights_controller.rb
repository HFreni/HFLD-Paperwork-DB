...
class SpotlightsController < ApplicationController
  before_action :set_spotlight, only: %i[show edit update destroy]
  before_action :prepare_color_list, only: %i[new edit update]
  before_action :prepare_people_list, only: %i[new edit update]
  before_action :prepare_position_list, only: %i[new edit update]
  before_action :prepare_model_list, only: %i[new edit update]
